...
export default function B2BPage() {
  return (
    <>
      ...
      {/* Offerings grid */}
      <section className="border-b border-stone/20 bg-mist">
        <Container className="py-14">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {OFFERINGS.map((o) => (
              <div key={o.title}>
                <h2 className="font-display text-h3">{o.title}</h2>
                <p className="mt-3 text-body text-slate">{o.body}</p>
              </div>
            ))}
          </div>
        </Container>
          ...
          <div className="grid gap-16 lg:grid-cols-[1fr_560px]">
            ...
            <div>
              ...
              <div className="mt-10 flex flex-col gap-4 border-t border-stone/20 pt-8">
                <div>
                  <p className="text-label uppercase tracking-[0.08em] text-slate">Email</p>
                  <a
                ...
                <div>
                  <p className="text-label uppercase tracking-[0.08em] text-slate">
                    Based in
                  </p>
